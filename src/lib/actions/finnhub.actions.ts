...
import { getDateRange, validateArticle, formatArticle } from '@/src/lib/utils';
import { POPULAR_STOCK_SYMBOLS } from '@/src/lib/constants';
import { cache } from 'react';

const FINNHUB_BASE_URL = 'https://finnhub.io/api/v1';
const NEXT_PUBLIC_FINNHUB_API_KEY = process.env.NEXT_PUBLIC_FINNHUB_API_KEY ?? '';

// Define proper type for stock profile
...
// Define type for search result with optional exchange
